          ...
          >
            <div align="center">
              ...
              {this.state.tableVis ? <div width="100%"> <Flex>
                ...
                : null}
              {this.state.completed ? !this.state.hide ? <Flash my={3} variant="info">
                {this.tick()}
                <Button.Text className="modal-close"
                  icononly
                  icon={"Close"}
                ...
                />
                {this.state.loading ? <div><Text>Proccessing transaction...</Text><Loader /></div> : null}
                <Flash.Link href={"https://algoexplorer.io/tx/" + this.state.txID}> Check progress on AlgoExplorer</Flash.Link>
              </Flash> : null : null}
